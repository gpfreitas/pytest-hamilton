...
publish_conda_forge:
	...
	echo "The two links below point to the same page — the live one for reading,"
	echo "the permalink for diffing against to see if these instructions need updating:"
	echo "    Live:      https://conda-forge.org/docs/maintainer/adding_pkgs/"
	echo "    Permalink: https://github.com/conda-forge/conda-forge.github.io/blob/d5534110597fae4abe2aeac15feb8a6cdd17b176/docs/maintainer/adding_pkgs.mdx"
	echo "               (pinned 2026-04-07)"
	echo ""
	...
	echo ""
	echo "Local checklist for this repo: docs/misc/conda-forge-submission/README.md"
	echo ""
